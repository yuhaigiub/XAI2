...
def generate_train_val_test(args):
    ...
    x, y = generate_graph_seq2seq_io_data(df, x_offsets=x_offsets, y_offsets=y_offsets, add_time_in_day=True)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="store/METR-LA", help="Output directory.")
    parser.add_argument("--traffic_df_filename", type=str, default=None, help="Raw traffic readings.",)
