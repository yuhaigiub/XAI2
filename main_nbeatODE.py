...
from nbeatODE.model import Model
...
parser.add_argument('--channels', type=str, default=2, help='channels')
parser.add_argument('--hidden', type=str, default=64, help='hidden players')
parser.add_argument('--num_layer', type=str, default=4, help='number players ')
